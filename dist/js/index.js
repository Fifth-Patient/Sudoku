...
var Toolkit = __webpack_require__(/*! ./toolkit */ "./src/js/core/toolkit.js"); // 输入：matrix，用户完成的数独数据，9 × 9
    ...
    value: function checkBoxes() {
      for (var boxIndex = 0; boxIndex < 9; boxIndex++) {
        ...
        for (var cellIndex = 0; cellIndex < 9; cellIndex++) {
          if (!marks[cellIndex]) {
            var _Toolkit$box$covertFr = Toolkit.box.covertFromBoxIndex(boxIndex, cellIndex),
                rowIndex = _Toolkit$box$covertFr.rowIndex,
                colIndex = _Toolkit$box$covertFr.colIndex;
...
function () {
  ...
  _createClass(Generator, [{
    ...
    value: function generate() {
      while (!this.interalGenerate()) {// Todo 
      }
    }
  }, {
    key: "interalGenerate",
    value: function interalGenerate() {
    ...
    value: function fillRow(n, rowIndex) {
      ...
      var orders = this.orders[rowIndex]; // Todo 随机选择列

      for (var i = 0; i < 9; i++) {
        var colIndex = orders[i]; // 这个位置已经有值，跳过
        ...
        row[colIndex] = n; // 去下一行填写n，如果没填进去，就继续寻找当前行的下一个位置
...
var boxToolkit = {
  ...
  covertFromBoxIndex: function covertFromBoxIndex(boxIndex, colIndex) {
    return {
...
function () {
  ...
  _createClass(Grid, [{
    ...
    value: function build() {
      var sudouku = new Sudoku();
      sudouku.make();
      var matrix = sudouku.puzzleMatrix;
...
function () {
  function PopupNumbers($panel) {
    ...
    this._$panel.on("click", function (e) {
      if ($(e.target).is(_this._$panel)) {
        _this.hide();
      ...
      if ($span.hasClass("mark1")) {
        ...
        if ($cell.hasClass("mark1")) {
          ...
          $cell.removeClass("makr2").addClass("mark1");
        }
      } else if ($span.hasClass("mark2")) {
        if ($cell.hasClass("mark2")) {
          $cell.removeClass("mark2");
        } else {
          $cell.removeClass("makr1").addClass("mark2");
        }
      } else if ($span.hasClass("empty")) {
        // empty，取消数字填写，取消mark
        $cell.text(0).removeClass("mark1").removeClass("mark2").addClass("empty");
      } else {
        $cell.removeClass("empty").text($span.text()); // 1-9 填数字        
      }
  ...
  _createClass(PopupNumbers, [{
    ...
    value: function popup($cell) {
      ...
      var num = Math.round(1 + Math.random() * (4 - 1));

      this._$panel.children().css({
        left: "".concat(left, "px"),
        top: "".concat(top, "px"),
        background: "url(./dist/img/bg-".concat(num, ".jpg) no-repeat"),
